...
export const INTRODUCE = [
  `안녕하세요. 만 ${getKoreanAge(PROFILE.birthDay)}세 ${getWorkAnniversary(EXPERIENCES.at(-1).startDate)}의 경력을 가진 주니어 프론트엔드 개발자 방은수입니다.`,
  'Typescript와 React, Next를 기반으로 개발을 하고 있으며, 주요 업무는 디자이너로부터 화면 레이아웃을 받아 공용 컴포넌트 및 페이지를 구축하고, 백엔드와의 API 연동을 통해 필요한 기능을 개발 및 최적화를 담당하고 있습니다.',

...
export const INTRODUCE = [
    ...
    'Typescript와 Next.js를 기반으로 개발을 하고 있습니다. 주요 업무는 디자이너로부터 화면 레이아웃을 받아 공용 컴포넌트 및 페이지를 구현하며, 백엔드와의 API 연동을 통해 필요한 기능을 개발 및 최적화를 담당하고 있습니다.',
                ...
                doneList: [
                        ...
                        details: [
                            {
                                ...
                                solution:
                                    '결과 데이터 상태 값에 throttle을 적용하여 불필요한 업데이트를 줄이고, 데이터 유실없이 안정적으로 렌더링되도록 개선',
                            },
                            {
                                problem:
                    ...
                    },
                    {
                        ...
                        details: [
                            ...
                            {
                                problem:
                                    '운영자가 여러 팀에 종속되는 경우, 어떤 팀의 운영자로 정보를 봐야하는지 혼란이 오는 문제가 발생',
                                solution:
                ...
                doneList: [
                    ...
                    },
                    {
                        ...
                        details: [
                            {
                                problem:
                                    '입력값이 문자열, 숫자, 배열 등 다양한 데이터 타입을 가질 수 있어 동적 타입 처리가 필요했음',
                                solution: '입력값을 \`JSON\`으로 변환하여 다양한 데이터 타입을 유연하게 처리할 수 있도록 개선',
                            },
                            {
                                problem:
                                    '사용자가 \`JSON\` 형식으로 입력해야 하는 데이터에 싱글 따옴표를 사용하여 잘못된 입력을 하였고, 그대로 저장하면 실행 중 오류가 발생하였음',
                                solution:
                                    '입력값이 문자열인 경우, 싱글 따옴표가 포함되어 있는지 확인하고 경고 메시지를 띄운 후 입력을 거부. 올바른 \`JSON\` 형식(`\"`)을 사용하도록 유도하여 문제 해결',
                            },
                            {
                                problem:
                                    '테스트 케이스 입력값이 문제에서 지정한 데이터 타입(\`int\`, \`float\`, \`boolean\` 등)과 일치하지 않아 실행 중 의도치 않은 오류가 발생',
                                solution:
                                    '입력값이 문제에서 지정한 데이터 타입과 일치하는지 사전에 체크하는 유효성 검사 로직을 적용하여 오류를 방지',
                            },
                        ],
                    },
                    {
                        ...
                        details: [
                            {
                                ...
                                solution:
                                    '시험 페이지 입장 시 미리 사용자의 답안지를 생성하는 api를 전송하도록 하고, 사용자가 답안을 체크할 때마다 서버에 PATCH 요청을 보내 시험 진행 상황을 실시간으로 저장하도록 개선',
                            },

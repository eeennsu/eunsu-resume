...
export const INTRODUCE = [
    ...
    ' 현재 React와 Next.js를 기반으로 한 웹 애플리케이션션 개발에 집중하고 있으며, 공용 컴포넌트 개발, 백엔드와의 API 연동, 사이트 구조 설계 및 최적화 등을 맡아 프로젝트를 진행하고 있습니다.',
    '또한 백엔드 개발자, 디자이너, 그리고 다른 팀원들과 긴밀하게 소통하며 개발을 하고 있습니다. 어떠한 문제나 개선점이 생겼을 때, 팀원들과 정확한 커뮤니케이션으로 문제를 해결하며 프로젝트를 높은 완성도로 마무리하는데 최선을 다하고자 합니다.',

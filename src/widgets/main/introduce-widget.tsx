        ...
        <section className='flex w-full'>
            ...
            <div className='flex flex-col gap-2 flex-grow'>
                <div className='flex flex-col gap-5 break-keep'>
                    ...
                    <p>
                        현재 React와 Next.js를 기반으로 한 웹 애플리케이션션 개발에 집중하고 있으며, 공용 컴포넌트 개발,
                        백엔드와의 API 연동, 사이트 구조 설계 및 최적화 등을 맡아 프로젝트를 진행하고 있습니다.
                    </p>
                    <p>
                        또한 백엔드 개발자, 디자이너, 그리고 다른 팀원들과 긴밀하게 소통하며 개발을 하고 있습니다. 어떠한 문제나
                        개선점이 생겼을 때, 팀원들과 정확한 커뮤니케이션으로 문제를 해결하며 프로젝트를 높은 완성도로 마무리하는
                        데 최선을 다하고자 합니다.
                    </p>
                    <p>
                        서비스 개발이란 결국 개발자와 비즈니스와의 원할한 소통이 핵심이라고 생각합니다. 능동적인 커뮤니케이션과
                        피드백을 통해 문제 해결과 비즈니스 성장을 위해 노력하고 있습니다. 이러한 점을 바탕으로 더 나은 개발자로서
                        성장하기 위해 항상 경험하고, 학습하며 성장해나갈 것입니다.
                    </p>
                </div>
            </div>
        </section>
